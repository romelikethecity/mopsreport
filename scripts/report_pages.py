...
ROLE_SHORT = "Marketing Ops"
LIST_SLUG = "mops-report"
CSS_PREFIX = "mops"
...
.report-hero .report-subtitle {
    font-size: 1.15rem;
    color: var(--mops-text-secondary, #64748b);
    margin-bottom: 0;
}
.report-content {
    max-width: 800px;
...
.report-stat-card {
    background: var(--mops-bg-surface, #fff);
    border: 1px solid var(--mops-border, #e2e8f0);
    border-radius: 12px;
    padding: 1.25rem;
    text-align: center;
}
...
.report-gate {
    background: #f8fafc;
    border: 2px solid var(--mops-accent);
    border-radius: 16px;
    padding: 2.5rem 2rem;
    text-align: center;
    margin: 2.5rem 0;
...
.report-gate-form input[type="email"] {
    ...
    font-size: 1rem;
    background: var(--mops-bg-surface, #fff);
    color: var(--mops-text-primary, #1e293b);
}
.report-gate-form button {
    padding: 0.75rem 1.75rem;
    background: var(--mops-accent);
    color: #fff;
    border: none;
    border-radius: 8px;
    font-size: 1rem;
...
.report-gate-form button:hover {
    background: var(--mops-accent-hover);
}
.report-download-btn {
    display: none;
